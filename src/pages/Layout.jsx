  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f7f6f2]">
      ...
      <main className="flex flex-1 flex-col justify-center px-[max(5%,calc((100%-1200px)/2))] py-20">
        ...
        <div className="mt-10">
          <a className="inline-block rounded-sm bg-[#2d362d] px-8 py-4 text-sm font-medium text-white transition-transform hover:scale-[1.02] active:scale-95 hover:bg-[#4d574d]">Reserva un taller</a>
        </div>
